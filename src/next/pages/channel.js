...
import Recordings, { RecordingsListItem } from '../components/Recordings'
...
//             }
            ...
            (page && !pageError) && <Fragment>
              ...
              <section>
                ...
                {
                  (count && products) && <Fragment>
                    <Recordings>{products.map((product, i) => (
                      <RecordingsListItem
                        key={product.id || i}
                        id={product.id}
                        wp={product}
                        ...
                        persons={product.acf.hide_persons ? [] : (product.acf.teachers.persons || []).map(({ person }) => ({ title: person.post_title, id: person.ID, wp: person}))}
                      />
                    ))}
                  </Recordings>
